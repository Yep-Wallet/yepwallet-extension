	...
	return (
		<Body>
			...
			<WarningMessage>
				...
				<br />
				<br /> This signature could potentially perform any operation on
				your account's behalf, including granting complete control of
				your account and all of its assets to the requesting site. Only
				sign this message if you know what you're doing or completely
			...
			{rawSignError && (
				<ErrorMessage>{rawSignError.message}</ErrorMessage>
			)}
